...
async (req, res) => {
    ...
    if (skills) {
        // Turn the comma separated string into an array (disregard any whitespaces between commas)
    ...
    try {
        ...
        if (profile) {
            // Update the profile if the profile already exists
...
router.put('/experience', [auth, [
    ...
    // Check if the following fields are not empty
...
// @desc    Get a user's repos from GitHub by their GitHub handle
// @access  Public
router.get('/github/:username', async (req, res) => {
    try {
        ...
        request(options, (error, response, body) => {
            ...
            // Return a 404 erorr if the response code isn't 200
